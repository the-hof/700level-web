...
User.prototype.save = function (username, password, email_address, callback) {
...
User.prototype.deleteUserName = function (username, callback) {
...
User.prototype.getByUsernamePassword = function(username, password, callback) {
   if ((username === '') || (password === '')) {
     return callback(err, new User());
   }
